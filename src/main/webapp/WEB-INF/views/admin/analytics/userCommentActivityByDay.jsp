...
<p>
    <canvas id="commentsActivityChart" width="800" height="400"></canvas>
    <script>

        var data;

        $.ajax({
            url: "/chart/commentsActivity/",
            type: "GET",
            dataType: 'json',
...
//                alert(data.labels);  // Goper
                var ctx = document.getElementById("commentsActivityChart").getContext("2d");
